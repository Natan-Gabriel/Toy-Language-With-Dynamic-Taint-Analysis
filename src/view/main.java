...
public class main {
  ...
  //int a; int v; a=1;(If a>0 Then v=2 Else v=3);Print(v) is represented as
   ...
   VarExp("v"))))));
	...
	PrgState prg1=new PrgState(exeStack1,symTable1,out1,fTbl1,heap1,ex1);
	PrgState prg2=new PrgState(exeStack2,symTable2,out2,fTbl2,heap2,ex2);
	...
	//varc=varf.readLine();System.out.println(varc);
	//readFile(varf,varc);System.out.println(varc);
	//closeRFile(varf) ;
