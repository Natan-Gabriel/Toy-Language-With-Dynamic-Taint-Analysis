...
//
	...
	//int a; int v; a=1;(If a>0 Then v=2 Else v=3);Print(v) is represented as
    //exemple generated by CUP
//		IStmt ex3 = new CompStmt(new CompStmt(new CompStmt(new VarDeclStmt("a",new IntType(),1),new CompStmt(new VarDeclStmt("b",new IntType(),1),new CompStmt(new VarDeclStmt("c",new IntType(),1),new CompStmt(new VarDeclStmt("d",new IntType(),1),new CompStmt(new VarDeclStmt("e",new IntType(),1),new CompStmt(new VarDeclStmt("f",new IntType(),1),new NopStmt())))))),new NopStmt()),new CompStmt(new CompStmt(new CompStmt(new CompStmt(new CompStmt(new CompStmt(new CompStmt(new CompStmt(new NopStmt(),new AssignStmt("a",new ValueExp(new IntValue(3)),2)),new AssignStmt("a",new ValueExp(new IntValue(2)),3)),new AssignStmt("b",new ValueExp(new IntValue(3)),4)),new AssignStmt("c",new ValueExp(new IntValue(4)),5)),new AssignStmt("d",new ValueExp(new IntValue(6)),5)),new AssignStmt("d",new ValueExp(new IntValue(7)),5)),new AssignStmt("e",new ValueExp(new IntValue(7)),6)),new AssignStmt("f",new ValueExp(new IntValue(8)),7)));


		MyIStack<IStmt> exeStack1=new MyStack<IStmt>();
		MyIStack<IStmt> exeStack_executed1=new MyStack<IStmt>();
	...
	MyIStack<IStmt> exeStack2=new MyStack<IStmt>();
		MyIStack<IStmt> exeStack_executed2=new MyStack<IStmt>();
...
//
	MyIStack<IStmt> exeStack3=new MyStack<IStmt>();
		MyIStack<IStmt> exeStack_executed3=new MyStack<IStmt>();
		MyIDictionary<Integer,IStmt> exeDictionary3=new MyDictionary<Integer,IStmt>();
...
//
	PrgState prg1=new PrgState(exeStack1,exeStack_executed1,exeDictionary1,symTable1,dynaimcSymTable1,out1,fTbl1,heap1,ex1);
	PrgState prg2=new PrgState(exeStack2,exeStack_executed2,exeDictionary2,symTable2,dynaimcSymTable2,out2,fTbl2,heap2,ex1);
	PrgState prg3=new PrgState(exeStack3,exeStack_executed3,exeDictionary3,symTable3,dynaimcSymTable3,out3,fTbl3,heap3,ex1);
...
//		IStmt ex = (IStmt) Parser.parse("files/goto_inside_while.txt");
		IStmt ex = (IStmt) Parser.parse("files/dumb6.txt");
