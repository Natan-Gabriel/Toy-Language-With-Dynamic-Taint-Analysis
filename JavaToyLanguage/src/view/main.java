...
//
    ...
    //exemple generated by CUP
		IStmt ex3 = new CompStmt(new CompStmt(new CompStmt(new VarDeclStmt("x",new IntType(),1),new CompStmt(new VarDeclStmt("y",new IntType(),1),new CompStmt(new VarDeclStmt("a",new IntType(),1),new NopStmt()))),new CompStmt(new CompStmt(new VarDeclStmt("z",new IntType(),2),new NopStmt()),new NopStmt())),new CompStmt(new CompStmt(new NopStmt(),new AssignStmt("x",new ValueExp(new IntValue(2)),3)),new AssignStmt("y",new ValueExp(new IntValue(3)),4)));
